...
def generate_launch_description():
    ...
    unitree_go_sim_dir = get_package_share_directory('unitree_go2_sim')
    pc_to_scan_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(unitree_go_sim_dir, 'launch', 'pointcloud_to_laserscan_launch.py')))
    slam_params = os.path.join(unitree_go2_sim, "config/mapper_params_online_async.yaml")
    ...
    rviz2 = Node(
        ...
        executable='rviz2',
        name='rviz2',
        arguments=['-d', os.path.join(unitree_go2_sim, "rviz/rviz_l1_slam.rviz")],
